...
class UserDeletePastAppointmentsScreen extends StatefulWidget {
  @override
  _UserDeletePastAppointmentsScreenState createState() =>
      _UserDeletePastAppointmentsScreenState();
}

class _UserDeletePastAppointmentsScreenState
    extends State<UserDeletePastAppointmentsScreen> {
  ...
  Future<void> _deleteAppointment(String id) async {
    try {
      // Delete the appointment from userpastappoint[]
      await _userPastAppointmentsCollection.doc(id).delete();
      setState(() {
